var reactVersions = {
  ...
  "cloud": "1.982.7",
  "components": "1.982.7",
  "componentsPreviewLayer": "1.982.7",
  "core": "1.982.7",
  "documentServices": "1.982.7",
  "editingRendererPlugins": "1.982.7",
  "fonts": "1.982.7",
  "layout": "1.982.7",
  "previewExtensionsCore": "1.982.7",
  "qaAutomation": "1.982.7",
  "server": "1.982.7",
  "skins": "1.982.7",
  "testUtils": "1.982.7",
  "tpa": "1.982.7",
  "tpaIntegration": "1.982.7",
  "tweenEngine": "1.982.7",
  "utils": "1.982.7",
  "wixSites": "1.982.7",
  "wixappsBuilder": "1.982.7",
  "wixappsClassics": "1.982.7",
  "wixappsCore": "1.982.7"
};
...
function getFullRjsConfig(rjsConfigFunc, packagesUtil, reactVersions, artifactData, serviceTopology) {
    ...
    function isAddress(paramValue) {
        return paramValue.indexOf('http://') === 0;
    }
